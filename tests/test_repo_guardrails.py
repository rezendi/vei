...
def test_hotspot_modules_stay_below_foundation_size_budget() -> None:
    ...
    budgets = {
        ...
        "vei/ui/_workspace_routes.py": 80,
        "vei/ui/_workspace_governor_routes.py": 320,
        "vei/ui/_workspace_story_routes.py": 90,
        "vei/ui/_workspace_route_context.py": 320,
        "vei/ui/_whatif_routes.py": 740,
        "vei/ui/_whatif_audit_routes.py": 280,
