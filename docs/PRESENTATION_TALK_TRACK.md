...
```bash
python -m vei.cli.vei showcase story \
...
If you want the generated guide beside the UI:

- [presentation_guide.md](/Users/rohit/Documents/Workspace/Coding/digital-enterprise-twin/_vei_out/vertical_showcase/story_presentation/real_estate_management/presentation_guide.md)
