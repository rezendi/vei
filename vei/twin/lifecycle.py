...
from ._saved_payloads import load_saved_governor_payload, load_saved_workforce_payload
...
def _load_saved_governor_payload(workspace_root: Path) -> dict[str, Any]:
    return load_saved_governor_payload(workspace_root)


def _load_saved_workforce_payload(workspace_root: Path) -> dict[str, Any]:
    return load_saved_workforce_payload(workspace_root)
