...
_PROFILES = {
    ...
    "okta_users_live_v1": MappingProfileSpec(
        name="okta_users_live_v1",
        source_system="okta",
        file_type="json",
        root_list_key="users",
        expected_fields=[
    ...
    "okta_groups_live_v1": MappingProfileSpec(
        name="okta_groups_live_v1",
        source_system="okta",
        file_type="json",
        root_list_key="groups",
        expected_fields=["group_id", "name", "description", "members"],
        required_fields=["group_id", "name"],
        list_fields=["members"],
        field_aliases={
    ...
    "okta_apps_live_v1": MappingProfileSpec(
        name="okta_apps_live_v1",
        source_system="okta",
        file_type="json",
        root_list_key="applications",
        expected_fields=[
            "app_id",
            "label",
            "status",
