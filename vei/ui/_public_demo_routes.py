...
_ACTION_SIGNAL_LABELS: tuple[tuple[str, str], ...] = (
    ...
    ("unemployment", "unemployment reports"),
...
def _suggested_actions(
    ...
    if state_point is None:
        return []
    signal_events = [
        *list(state_point.evidence_events),
        *list(state_point.history_events)[-120:],
    ]
    ...
    *,
    ...
    return sorted(
        ...
        key=lambda item: (
            ...
            group_priority.get(item[0].key, 100),
